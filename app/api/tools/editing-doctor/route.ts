...
export async function POST(req: NextRequest) {
  try {
    const access = await checkApiAccess('editing-doctor');
    ...
    void logToolUse({ userId: access.userId, eventType: 'editing_doctor_session', eventData: { mode: body.mode, score: result.score } });
